...
int main(int argc, char *argv[])
{
	 ...
	 * Try /var/tmp first (usually a real filesystem like 9p in QEMU),
	 * exhausting both O_TMPFILE and named-file options there before
	 * falling back to /tmp which may be tmpfs/shmem.
	 */
